...
export async function harvestNewRepoZeroStarsUsers() {
  ...
  try {
    for (let page = 1; page <= maxPages; page++) {
      ...
      if (remaining < 10) {
        console.warn("⏸️ Çok az API hakkı kaldı, işlem sonlandırılıyor.");
        break;
      }
      ...
      for (const repo of repos) {
        ...
        await safeDelay(); // Her kullanıcıdan sonra bekle (güvenli mod)
      }
    }
